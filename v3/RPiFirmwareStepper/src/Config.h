...
#define DC_MOTORS_FREQ_HZ				2000

const uint8_t DC_CUTTER_DEFAULT_SPEED 	= 255;

//const uint8_t DC_MOTOR_DEFAULT_SPEED 	= 200;
//const uint8_t DC_MOTOR_DOWN_SPEED 		= 90;
//const uint8_t DC_MOTOR_MASTER_RESET_SPEED = 90;
//const uint8_t DC_MOTOR_SLAVE_RESET_SPEED = 70;


/* Vertical movement and encoders settings */
const float MM_PER_STEP 				= 1.5;
const float VERTICAL_MM_OFFSET 			= 345;	/* mm */
